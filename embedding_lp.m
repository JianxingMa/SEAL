function [auc] = embedding_lp(train_mix, test, ith_experiment, data_name, emd_method)   
...
%%
    ...
    % generate embedding
    % whether to use negative injection (default not, as LR has low capacity, already regularize a lot)
    for runthis = 1:0
